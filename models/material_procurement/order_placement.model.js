...
const OrderPlacementSchema = new mongoose.Schema(
    {
        ...
        items: [{
            inquiryId: {type: mongoose.Schema.Types.ObjectId, ref: "material-inquiry", required: true, trim: true },
            inquiryItem: { type: mongoose.Schema.Types.ObjectId, ref: "store-items" },
            item: {type: mongoose.Schema.Types.ObjectId, ref: "store-items", required: true, trim: true },
...
module.exports = mongoose.model("material-order-placement", OrderPlacementSchema);