...
const stockSurfacePrimerInspectionSchema = new Schema({
    project_id: {
...
module.exports = mongoose.model('multi-piping-stock-surface-inspection', stockSurfacePrimerInspectionSchema);
